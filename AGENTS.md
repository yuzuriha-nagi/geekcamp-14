...
- The project's objective is to create a new application with functionality similar to the existing web application's WebCampass, featuring a refined UI and other improvements.
