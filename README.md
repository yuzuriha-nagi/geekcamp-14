...
The root route now redirects to `/login`, which renders the WebCampass-style form. Run `npm run dev` and open [http://localhost:3000/login](http://localhost:3000/login) to test the flow.
